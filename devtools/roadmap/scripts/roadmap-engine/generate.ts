...
const CURATED_REQUIRED_SUBFEATURES: Record<string, string[]> = {
  ...
  'roadmap tool': [
    ...
    'Roadmap Tool > Layout Persistence',
    'Roadmap Tool > Node Test Execution Capability',
    'Roadmap Tool > Roadmap API Surface',
    'Roadmap Tool > Documentation Intelligence',
    'Roadmap Tool > Strategic Opportunity Mapping',
...
const IMAGE_GEN_DEV_SYNTHETIC_DOCS: ProcessingDocument[] = [
  {
    ...
    subFeatures: [
      ...
      { name: 'Race Portrait Image Generation > Future Capability Expansion > Fail Fast Branch Test Orchestration', state: 'active', canonicalPath: 'devtools/roadmap/scripts/roadmap-engine/generate.ts' },
      { name: 'Race Portrait Image Generation > Future Capability Expansion > Node Test Definition Registry', state: 'done', canonicalPath: 'devtools/roadmap/scripts/roadmap-engine/types.ts' },
      { name: 'Race Portrait Image Generation > Future Capability Expansion > Fail Fast Branch Test Executor', state: 'done', canonicalPath: 'devtools/roadmap/scripts/roadmap-node-test.ts' },
      { name: 'Race Portrait Image Generation > Future Capability Expansion > Test Log Retention Policy', state: 'active', canonicalPath: 'devtools/roadmap/scripts/roadmap-engine/node-test-status.ts' },
      { name: 'Race Portrait Image Generation > Future Capability Expansion > Roadmap Node Test Badges', state: 'planned', canonicalPath: 'devtools/roadmap/src/components/debug/roadmap/RoadmapVisualizer.tsx' }
    ]
  }
];
