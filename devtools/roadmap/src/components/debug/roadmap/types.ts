...
export interface RoadmapNode {
  ...
  // Optional module implementation file links used by atomization health signals.
  componentFiles?: string[];
  // Technical: node-level verification metadata generated by roadmap engine.
  // Layman: tells the UI what test belongs to this node and whether it last passed.
  testId?: string;
  testCommand?: string;
...
export interface DetailEntry {
  ...
  // Technical: source roadmap node ids represented by this rendered detail entry.
  // Layman: a visual branch card may represent one or more underlying roadmap nodes.
...
export interface RenderNode {
  ...
  hasChildren?: boolean;
  expanded?: boolean;
  // Technical: true when the node is intentionally compacted into a stub while its
  // parent branch remains open.
  // Layman: this card is manually folded down so sibling lanes stay open around it.
  collapsed?: boolean;
