...
- Stay in terminal (no browser); grab UI context via DevTools snapshots if needed.
...
- Paths: root is `C:\Users\gambi\Documents\Git\AraliaV4\Aralia`; avoid double `Users\Users` prefixes when cd’ing.
