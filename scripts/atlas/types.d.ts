...
export type DocRole = 'architecture' | 'decision' | 'gap' | 'handoff' | 'north_star' | 'plan' | 'process' | 'proof' | 'reference' | 'runbook' | 'tracker';
export type PlanStatus = 'proposed' | 'approved' | 'active' | 'partially_done' | 'done' | 'superseded' | 'blocked' | 'stale_review_needed';
