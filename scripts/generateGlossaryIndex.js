...
const RACE_GROUP_DEFS = [
  ...
  },
  {
    id: "draconic_kin",
    title: "Draconic Kin",
    excerpt: "Dragon-blooded humanoids including dragonborn and kobolds.",
    ids: ["dragonborn", "kobold"],
  ...
  },
  {
    id: "greenskins",
    title: "Greenskins",
    excerpt: "Orcish and goblinoid humanoids.",
    ids: ["goblin", "hobgoblin", "bugbear", "orc", "verdan", "half-orc"],
    baseRaceIds: ["half_orc"],
    primaryIds: ["orc", "goblin"],
  },
  {
    id: "goliath",
    title: "Goliath",
  ...
  },
  {
    id: "feyfolk",
    title: "Feyfolk",
    excerpt: "Creatures with ties to the Feywild and fey nature.",
    ids: ["fairy", "satyr", "centaur", "firbolg"],
  },
  {
    id: "constructed",
    title: "Constructed",
    excerpt: "Sentient beings built rather than born.",
    ids: ["warforged", "autognome"],
  },
  {
    id: "planar_travelers",
    title: "Planar Travelers",
    excerpt: "Beings with origins beyond the Material Plane.",
    ids: ["kalashtar", "kender", "triton", "simic_hybrid", "vedalken"],
  },
  {
    id: "halfling",
    title: "Halfling",
  ...
  },
  {
    id: "shapeshifters",
    title: "Shapeshifters",
    excerpt: "Form-changing beings including shifters, changelings, and plasmoids.",
    ids: ["shifter", "changeling", "plasmoid"],
    baseRaceIds: ["shifter", "shapeshifters"],
    pathPrefixes: ["races/shifter_variants/"],
    primaryIds: ["shifter", "changeling"],
  },
  {
    id: "tiefling",
    title: "Tiefling",
