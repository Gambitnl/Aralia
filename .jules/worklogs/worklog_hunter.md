...
## 2025-12-30 - [Stale TODO Cleanup] **Learning:** TODOs related to testing configurations (e.g., temporarily forcing spawn rates) can easily be forgotten in the codebase, leading to confusion about intended behavior (e.g., "Is this still a test setting?"). **Action:** When resolving such TODOs, if the behavior is to be kept, replace the TODO with a clear "Note" comment explaining the decision (e.g., "Villages are guaranteed to spawn") to remove ambiguity.
