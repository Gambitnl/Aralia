...
```typescript
// [Depthcrawler] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_depthcrawler.md`):
...
```typescript
// TODO(Depthcrawler): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🕷️ Depthcrawler: [Description]`
