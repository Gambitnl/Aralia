...
```typescript
// [Analyst] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_analyst.md`):
...
```typescript
// TODO(Analyst): Alternative approach - [brief description of Option B]
```
