...
```typescript
// [Worldsmith] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_worldsmith.md`):
...
```typescript
// TODO(Worldsmith): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🌍 Worldsmith: [Description]`
