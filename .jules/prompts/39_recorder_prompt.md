...
```typescript
// [Recorder] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_recorder.md`):
...
```typescript
// TODO(Recorder): Alternative approach - [brief description of Option B]
```
