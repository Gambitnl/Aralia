...
```typescript
// [Bard] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_bard.md`):
...
```typescript
// TODO(Bard): Alternative approach - [brief description of Option B]
```
