...
```typescript
// [Linker] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_linker.md`):
...
```typescript
// TODO(Linker): Alternative approach - [brief description of Option B]
```
