...
```typescript
// [Steward] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_steward.md`):
...
```typescript
// TODO(Steward): Alternative approach - [brief description of Option B]
```
