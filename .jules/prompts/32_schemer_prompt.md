...
```typescript
// [Schemer] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_schemer.md`):
...
```typescript
// TODO(Schemer): Alternative approach - [brief description of Option B]
```
