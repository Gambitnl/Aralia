...
```typescript
// [Gardener] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_gardener.md`):
...
```typescript
// TODO(Gardener): Alternative approach - [brief description of Option B]
```
