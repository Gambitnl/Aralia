...
```typescript
// [Forge] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_forge.md`):
...
```typescript
// TODO(Forge): Alternative approach - [brief description of Option B]
```
