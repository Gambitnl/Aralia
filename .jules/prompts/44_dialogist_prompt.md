...
```typescript
// [Dialogist] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_dialogist.md`):
...
```typescript
// TODO(Dialogist): Alternative approach - [brief description of Option B]
```
...
**PR title:** `💬 Dialogist: [Description]`
