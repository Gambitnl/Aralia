...
```typescript
// [Vanguard] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_vanguard.md`):
...
```typescript
// TODO(Vanguard): Alternative approach - [brief description of Option B]
```
...
**PR title:** `⚔️ Vanguard: [Description]`
