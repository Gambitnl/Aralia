...
```typescript
// [Castellan] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_castellan.md`):
...
```typescript
// TODO(Castellan): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🏰 Castellan: [Description]`
