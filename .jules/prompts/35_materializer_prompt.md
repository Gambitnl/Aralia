...
```typescript
// [Materializer] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_materializer.md`):
...
```typescript
// TODO(Materializer): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🎨 Materializer: [Description]`
