...
```typescript
// [Vector] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_vector.md`):
...
```typescript
// TODO(Vector): Alternative approach - [brief description of Option B]
```
