...
```typescript
// [Economist] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_economist.md`):
...
```typescript
// TODO(Economist): Alternative approach - [brief description of Option B]
```
...
**PR title:** `💰 Economist: [Description]`
