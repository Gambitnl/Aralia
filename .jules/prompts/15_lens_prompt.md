...
```typescript
// [Lens] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_lens.md`):
...
```typescript
// TODO(Lens): Alternative approach - [brief description of Option B]
```
