...
```typescript
// [Alchemist] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_alchemist.md`):
...
```typescript
// TODO(Alchemist): Alternative approach - [brief description of Option B]
```
...
**PR title:** `⚗️ Alchemist: [Description]`
