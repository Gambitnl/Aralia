...
```typescript
// [Warden] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_warden.md`):
...
```typescript
// TODO(Warden): Alternative approach - [brief description of Option B]
```
