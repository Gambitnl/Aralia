...
```typescript
// [Shadowbroker] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_shadowbroker.md`):
...
```typescript
// TODO(Shadowbroker): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🌑 Shadowbroker: [Description]`
