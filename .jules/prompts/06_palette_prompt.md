...
```typescript
// [Palette] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_palette.md`):
...
```typescript
// TODO(Palette): Alternative approach - [brief description of Option B]
```
