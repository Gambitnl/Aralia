...
```typescript
// [Timekeeper] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_timekeeper.md`):
...
```typescript
// TODO(Timekeeper): Alternative approach - [brief description of Option B]
```
...
**PR title:** `⏳ Timekeeper: [Description]`
