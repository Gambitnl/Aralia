...
```typescript
// [Planeshifter] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_planeshifter.md`):
...
```typescript
// TODO(Planeshifter): Alternative approach - [brief description of Option B]
```
...
**PR title:** `✨ Planeshifter: [Description]`
