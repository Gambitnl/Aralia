...
```typescript
// [Warlord] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_warlord.md`):
...
```typescript
// TODO(Warlord): Alternative approach - [brief description of Option B]
```
...
**PR title:** `⚔️ Warlord: [Description]`
