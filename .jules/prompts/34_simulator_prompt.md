...
```typescript
// [Simulator] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_simulator.md`):
...
```typescript
// TODO(Simulator): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🎲 Simulator: [Description]`
