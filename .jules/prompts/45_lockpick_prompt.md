...
```typescript
// [Lockpick] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_lockpick.md`):
...
```typescript
// TODO(Lockpick): Alternative approach - [brief description of Option B]
```
