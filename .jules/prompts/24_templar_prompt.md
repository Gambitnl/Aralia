...
```typescript
// [Templar] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_templar.md`):
...
```typescript
// TODO(Templar): Alternative approach - [brief description of Option B]
```
