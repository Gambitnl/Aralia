...
```typescript
// [Captain] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_captain.md`):
...
```typescript
// TODO(Captain): Alternative approach - [brief description of Option B]
```
