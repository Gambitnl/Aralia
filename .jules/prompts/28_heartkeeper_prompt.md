...
```typescript
// [Heartkeeper] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_heartkeeper.md`):
...
```typescript
// TODO(Heartkeeper): Alternative approach - [brief description of Option B]
```
...
**PR title:** `💕 Heartkeeper: [Description]`
