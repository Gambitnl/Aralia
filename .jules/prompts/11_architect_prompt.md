...
```typescript
// [Architect] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_architect.md`):
...
```typescript
// TODO(Architect): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🏗️ Architect: [Description]`
