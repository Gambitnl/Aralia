...
```typescript
// [Mechanist] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_mechanist.md`):
...
```typescript
// TODO(Mechanist): Alternative approach - [brief description of Option B]
```
...
**PR title:** `⚙️ Mechanist: [Description]`
