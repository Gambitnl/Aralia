...
```typescript
// [Wanderer] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_wanderer.md`):
...
```typescript
// TODO(Wanderer): Alternative approach - [brief description of Option B]
```
