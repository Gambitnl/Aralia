...
```typescript
// [Hunter] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_hunter.md`):
...
```typescript
// TODO(Hunter): Alternative approach - [brief description of Option B]
```
