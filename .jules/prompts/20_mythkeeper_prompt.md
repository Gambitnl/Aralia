...
```typescript
// [Mythkeeper] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_mythkeeper.md`):
...
```typescript
// TODO(Mythkeeper): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🏛️ Mythkeeper: [Description]`
