...
```typescript
// [Bolt] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_bolt.md`):
...
```typescript
// TODO(Bolt): Alternative approach - [brief description of Option B]
```
