...
```typescript
// [Scribe] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_scribe.md`):
...
```typescript
// TODO(Scribe): Alternative approach - [brief description of Option B]
```
