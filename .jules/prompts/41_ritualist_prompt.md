...
```typescript
// [Ritualist] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_ritualist.md`):
...
```typescript
// TODO(Ritualist): Alternative approach - [brief description of Option B]
```
...
**PR title:** `⭐ Ritualist: [Description]`
