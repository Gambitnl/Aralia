...
```typescript
// [Oracle] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_oracle.md`):
...
```typescript
// TODO(Oracle): Alternative approach - [brief description of Option B]
```
