...
```typescript
// [Chronicler] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_chronicler.md`):
...
```typescript
// TODO(Chronicler): Alternative approach - [brief description of Option B]
```
...
**PR title:** `📖 Chronicler: [Description]`
