...
```typescript
// [Ecologist] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_ecologist.md`):
...
```typescript
// TODO(Ecologist): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🌿 Ecologist: [Description]`
