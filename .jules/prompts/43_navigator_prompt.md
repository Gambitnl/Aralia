...
```typescript
// [Navigator] Brief explanation of what this code does and why
```
...
1. **Document** the decision in your worklog (`.jules/worklogs/worklog_navigator.md`):
...
```typescript
// TODO(Navigator): Alternative approach - [brief description of Option B]
```
...
**PR title:** `🧭 Navigator: [Description]`
