...
| Line | Snippet |
|---|---|
| 32 | `- **Description**: You whisper a discordant melody that only one creature of your choice within range can hear, wracking it with terrible pain. The ta...` |
...
| Line | Snippet |
|---|---|
| 32 | `- **Conditions Applied**: Deafened` |
| 34 | `- **Description**: For the duration, no sound can be created within or pass through a 20-foot-radius Sphere centered on a point you choose within rang...` |
...
| 37 | `\| 41-50 \| The target has the Deafened condition for 1 minute. \|` |

### `docs/spells/reference/level-8/dark-star.md`

| Line | Snippet |
|---|---|
| 37 | `- **Description**: This spell creates a sphere centered on a point you choose within range. The sphere can have a radius of up to 40 feet. The area wi...` |
...
| Line | Snippet |
|---|---|
| 33 | `- **Description**: A churning storm cloud forms for the duration, centered on a point within range and spreading to a radius of 300 feet. Each creatur...` |
...
### `public/data/glossary/entries/rules/conditions/deafened_condition.json`

| Line | Snippet |
|---|---|
| 3 | `"title": "Deafened",` |
| 7 | `"deafened",` |
| 10 | `"excerpt": "A deafened creature can't hear and automatically fails any ability check that requires hearing.",` |
| 14 | `"markdown": "# Deafened\r\n\r\nWhile you have the Deafened condition, you experience the following effect:\r\n\r\n*   **Can't Hear.** You can't hear a...` |
...
| 890 | `"title": "Deafened",` |
| 894 | `"deafened",` |
| 897 | `"excerpt": "A deafened creature can't hear and automatically fails any ability check that requires hearing.",` |

### `public/data/spells/level-1/dissonant-whispers.json`

| Line | Snippet |
|---|---|
| 171 | `"description": "You whisper a discordant melody that only one creature of your choice within range can hear, wracking it with terrible pain. The targe...` |
...
| Line | Snippet |
|---|---|
| 139 | `"description": "For the duration, no sound can be created within or pass through a 20-foot-radius Sphere centered on a point you choose within range. ...` |
...
### `public/data/spells/level-8/dark-star.json`

| Line | Snippet |
|---|---|
| 117 | `"description": "This spell creates a sphere centered on a point you choose within range. The sphere can have a radius of up to 40 feet. The area withi...` |
...
| Line | Snippet |
|---|---|
| 117 | `"description": "A churning storm cloud forms for the duration, centered on a point within range and spreading to a radius of 300 feet. Each creature u...` |
