...
| T3 | blocked | Resolve G3 completion-scope routing for duplicate cleanup. | human/project owner | 2026-06-08 | `docs/projects/documentation-cleanup/GAPS.md`, `docs/projects/documentation-cleanup/NORTH_STAR.md` Required Review Brief | Choose whether to formally widen duplicate-cleanup, close it as complete enough, or preserve it as adjacent evidence only. | Add a project decision row once scope is explicitly decided. |
