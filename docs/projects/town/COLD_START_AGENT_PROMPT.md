...
gaps: docs/projects/town/GAPS.md
---
# Town Cold Start Agent Handoff
...
Project entry point:
docs/projects/town/NORTH_STAR.md
...
Project: Town
Project folder: docs/projects/town
iteration: 2
Shared workflow: docs/agent-workflows/living-project-task-protocol/ITERATION_AGENT_WORKFLOW.md
Workflow gaps: docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
Dashboard schema: docs/projects/PROJECT_CARD_SCHEMA.md
North Star: docs/projects/town/NORTH_STAR.md
Tracker: docs/projects/town/TRACKER.md
Gaps: docs/projects/town/GAPS.md
...
Active task:
T2 - Validate town entry contract and town-description coupling boundaries.
...
Key files to touch:
- docs/projects/town/NORTH_STAR.md
- docs/projects/town/TRACKER.md
- docs/projects/town/GAPS.md
- docs/projects/town/COLD_START_AGENT_PROMPT.md
...
- docs/projects/town/GAPS.md
- docs/projects/town/COLD_START_AGENT_PROMPT.md
- docs/projects/town/DECISIONS.md
- docs/projects/town/AUDIT_OR_PROOF.md
- docs/projects/town/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/town plus source/docs named by the active tracker task
