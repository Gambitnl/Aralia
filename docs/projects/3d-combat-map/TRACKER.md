...
Current resume path: T4 is done, NC1 is complete (G2 closed, independently reproduced 2026-06-08), G4 now has a live browser slope-click proof (closed 2026-06-09), and G6 is now closed after a focused terrain-shader console sweep. NC2 was attempted 2026-06-08 and is **blocked (G7)**: the offline save fixture loads the World3D surface with no System Menu, so the headless combat path is unreachable. Next open work: unblock NC2 (G7), continue the remaining G3/G5 follow-ups, or take a bounded G9/G10 tactical readability proof slice. Pick the highest-value in-scope item first. Note 2026-06-10: the G7 combat-fixture work is accepted and queued for the current session window (owner session — see `docs/projects/DECISION_BLITZ_2026-06-10.md`, "Items converted to work"); G7 remains open until the fixture exists and NC2 passes.
