...
gaps: docs/projects/visibility/GAPS.md
---
# Visibility Cold Start Agent Handoff
...
Project entry point:
docs/projects/visibility/NORTH_STAR.md
...
Project folder: docs/projects/visibility
iteration: 2
Shared workflow: docs/agent-workflows/living-project-task-protocol/ITERATION_AGENT_WORKFLOW.md
Workflow gaps: docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
Dashboard schema: docs/projects/PROJECT_CARD_SCHEMA.md
North Star: docs/projects/visibility/NORTH_STAR.md
Tracker: docs/projects/visibility/TRACKER.md
Gaps: docs/projects/visibility/GAPS.md
...
Active task:
V-2 - Verify renderer integration evidence and classify non-local gaps for routing.
...
Key files to touch:
- docs/projects/visibility/NORTH_STAR.md
- docs/projects/visibility/TRACKER.md
- docs/projects/visibility/GAPS.md
- docs/projects/visibility/COLD_START_AGENT_PROMPT.md
...
- docs/projects/visibility/GAPS.md
- docs/projects/visibility/COLD_START_AGENT_PROMPT.md
- docs/projects/visibility/DECISIONS.md
- docs/projects/visibility/AUDIT_OR_PROOF.md
- docs/projects/visibility/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/visibility plus source/docs named by the active tracker task
