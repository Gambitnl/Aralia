...
gaps: docs/projects/ollama-service/GAPS.md
---
# Ollama Service Cold Start Agent Handoff
...
Project entry point:
docs/projects/ollama-service/NORTH_STAR.md
...
Active task:
T2 - Verify and document local-remote integration boundary for AI generation
...
Key files to touch:
- docs/projects/ollama-service/NORTH_STAR.md
- docs/projects/ollama-service/TRACKER.md
- docs/projects/ollama-service/GAPS.md
- docs/projects/ollama-service/COLD_START_AGENT_PROMPT.md
...
- docs/projects/ollama-service/GAPS.md
- docs/projects/ollama-service/COLD_START_AGENT_PROMPT.md
- docs/projects/ollama-service/DECISIONS.md
- docs/projects/ollama-service/AUDIT_OR_PROOF.md
- docs/projects/ollama-service/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/ollama-service plus source/docs named by the active tracker task
