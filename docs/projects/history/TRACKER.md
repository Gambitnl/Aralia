...
| T5 | done | Implement Bounded Importance-Aware Retention policy for worldHistory. | Gemini 3.1 Pro (High) | 2026-06-18 | `src/utils/world/historyUtils.ts` | Prune logic implemented and wired to `addHistoryEvent`. | Unit tests written in `historyUtils.test.ts`. Test runner blocked by host PS error. |
