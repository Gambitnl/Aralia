...
---
# Gemini Service Cold Start Agent Handoff
...
- docs/projects/gemini-service/DECISIONS.md
- docs/projects/gemini-service/AUDIT_OR_PROOF.md
- docs/projects/gemini-service/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/gemini-service plus source/docs named by the active tracker task
