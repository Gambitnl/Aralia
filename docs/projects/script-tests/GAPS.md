...
Status: merged-reference — gaps owned by scripts-quality since 2026-06-10
...
> Merge note (2026-06-10): Script Tests merged into Scripts: Quality (Remy,
> `docs/projects/DECISION_BLITZ_2026-06-10.md` D21). The gap rows below remain
> open and valid, but ownership and worker assignment now run through
> `docs/projects/scripts-quality` (this folder is its support surface).
