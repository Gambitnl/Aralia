...
- `T2` is now blocked on the G1 review brief; `G4` remains resolved through explicit teleport dispatch in `AbilityCommandFactory`. *(2026-06-10: the G1 review brief is resolved — command context owns the delegated payload, DECISION_BLITZ D9 — so T2 is unblocked for implementation.)*
