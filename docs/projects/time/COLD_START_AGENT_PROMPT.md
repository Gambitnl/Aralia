...
gaps: docs/projects/time/GAPS.md
---
# Time Cold Start Agent Handoff
...
Project entry point:
docs/projects/time/NORTH_STAR.md
...
Project: Time System
Project folder: docs/projects/time
iteration: 2
Shared workflow: docs/agent-workflows/living-project-task-protocol/ITERATION_AGENT_WORKFLOW.md
Workflow gaps: docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
Dashboard schema: docs/projects/PROJECT_CARD_SCHEMA.md
North Star: docs/projects/time/NORTH_STAR.md
Tracker: docs/projects/time/TRACKER.md
Gaps: docs/projects/time/GAPS.md
...
Active task:
T2 - Close in-scope timing uncertainties with test-backed notes
...
Key files to touch:
- docs/projects/time/NORTH_STAR.md
- docs/projects/time/TRACKER.md
- docs/projects/time/GAPS.md
- docs/projects/time/COLD_START_AGENT_PROMPT.md
...
- docs/projects/time/GAPS.md
- docs/projects/time/COLD_START_AGENT_PROMPT.md
- docs/projects/time/DECISIONS.md
- docs/projects/time/AUDIT_OR_PROOF.md
- docs/projects/time/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/time plus source/docs named by the active tracker task
