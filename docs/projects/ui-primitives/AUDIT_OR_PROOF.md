...
|---|---|---|---|
| 2026-06-10 | Required-doc surface initialized | pass | `docs/projects/ui-primitives/NORTH_STAR.md` declares this file in `required_docs`; schema migration created the file for audit-clean doc coverage. |
