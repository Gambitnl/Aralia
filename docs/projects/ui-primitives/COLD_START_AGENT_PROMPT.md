...
- docs/projects/ui-primitives/GAPS.md
- docs/projects/ui-primitives/COLD_START_AGENT_PROMPT.md
- docs/projects/ui-primitives/DECISIONS.md
- docs/projects/ui-primitives/AUDIT_OR_PROOF.md
- docs/projects/ui-primitives/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/ui-primitives plus source/docs named by the active tracker task
