# NORTHSTAR: Sideproject: Basic Chat Cold Start Agent Handoff
...
Project entry point:
docs/projects/sideproject-basic-chat/NORTH_STAR.md

---BEGIN NEXT AGENT HANDOFF---
Project: NORTHSTAR: Sideproject: Basic Chat
Project folder: docs/projects/sideproject-basic-chat
Iteration: 2
Shared workflow: docs/agent-workflows/living-project-task-protocol/ITERATION_AGENT_WORKFLOW.md
North Star: docs/projects/sideproject-basic-chat/NORTH_STAR.md
Tracker: docs/projects/sideproject-basic-chat/TRACKER.md
Gaps: docs/projects/sideproject-basic-chat/GAPS.md
...
Active task:
T2 - Resolve active vs reference-only status from registry note
...
Key files to touch:
- docs/projects/sideproject-basic-chat/NORTH_STAR.md
- docs/projects/sideproject-basic-chat/TRACKER.md
- docs/projects/sideproject-basic-chat/GAPS.md
- docs/projects/sideproject-basic-chat/COLD_START_AGENT_PROMPT.md
