...
| Field | Value |
|---|---|
| Project | Sideproject Basic Chat |
| Slug | sideproject-basic-chat |
| Category | active project |
| Status | active |
| Confidence | unknown |
| Evidence | docs/projects/sideproject-basic-chat/TRACKER.md; docs/projects/sideproject-basic-chat/GAPS.md |
| Gap signal | present |
