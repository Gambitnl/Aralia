...
| T3 | active | Resolve demo area retention decision | Worker B | 2026-05-31 | `docs/projects/demo-area/GAPS.md`, `docs/projects/PROJECT_TRACKER.md` | Decide keep/move/remove for `src/components/demo/CombatMessagingDemo.tsx`; add mount path if keeping | App route/action evidence and state transition updates |
