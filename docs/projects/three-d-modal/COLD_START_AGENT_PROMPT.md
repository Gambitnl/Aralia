...
gaps: docs/projects/three-d-modal/GAPS.md
---
# Three D Modal Cold Start Agent Handoff
...
Project entry point:
docs/projects/three-d-modal/NORTH_STAR.md
...
Active task:
T4 - Align gap tracking with concrete evidence and next checks
...
Key files to touch:
- docs/projects/three-d-modal/NORTH_STAR.md
- docs/projects/three-d-modal/TRACKER.md
- docs/projects/three-d-modal/GAPS.md
- docs/projects/three-d-modal/COLD_START_AGENT_PROMPT.md
...
- docs/projects/three-d-modal/GAPS.md
- docs/projects/three-d-modal/COLD_START_AGENT_PROMPT.md
- docs/projects/three-d-modal/DECISIONS.md
- docs/projects/three-d-modal/AUDIT_OR_PROOF.md
- docs/projects/three-d-modal/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/three-d-modal plus source/docs named by the active tracker task
