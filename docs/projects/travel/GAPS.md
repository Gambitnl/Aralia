...
Still open (2, both design-gated): **G4** (transport schema: wagon/cart pullers + load limits — needs the mechanic introduced first); **G11** (unified quest↔discovered marker-merge contract — needs a product decision).
