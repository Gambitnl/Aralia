...
| T2 | active | Clarify/route in-project gaps for implementation handoff and risk control. | Worker A | 2026-05-31 | `docs/projects/companions/GAPS.md` | Add `support_needed_now` decisions in the next implementation slice. | Each gap should have owner + source + next proof. |
