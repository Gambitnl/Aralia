...
Status: active — S4 decision recorded 2026-06-10
...
| S4 | done | blocked_human_decision | project owner | policy | review | How much of `scripts/audits` should be mandatory in CI versus optional/manual workflows is still undecided | `docs/guides/RACE_ENRICHMENT_WORKFLOW.md`, `docs/portraits/race_portrait_regen_handoff.md`, `docs/projects/DECISION_BLITZ_2026-06-10.md` (D20) | Over-broad automation can block normal contributor flow, while under-coverage can miss regressions | **Decided 2026-06-10 (Remy, DECISION_BLITZ D20):** audits stay optional/manual; no CI gates this cycle; revisit when the audit suite stabilizes. Unblocks CMA-G19 under the manual policy. Recorded in `DECISIONS.md` D2. | Decision recorded 2026-06-10 in project docs; re-open only if a gating proposal returns |
