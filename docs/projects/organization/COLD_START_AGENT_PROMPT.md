...
Active task:
T2 - Capture concrete integration debt for organi
...
- docs/projects/organization/DECISIONS.md
- docs/projects/organization/AUDIT_OR_PROOF.md
- docs/projects/organization/RUNBOOK.md
- docs/projects/PROJECT_CARD_SCHEMA.md
- docs/agent-workflows/living-project-task-protocol/WORKFLOW_GAPS.md
- docs/projects/organization plus source/docs named by the active tracker task
