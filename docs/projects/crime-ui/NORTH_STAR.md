...
Protocol: living project doc set
Next step: Resolve G4 (safehouse service source-of-truth) and G3 (heist plan type narrowing) as the most actionable in-scope gaps before adding new UI slices.
