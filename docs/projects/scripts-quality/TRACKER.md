...
| T3 | active | Capture quality-monitoring gaps and define next checks | Worker C | 2026-05-31 | [docs/projects/scripts-quality/GAPS.md](F:/Repos/Aralia/docs/projects/scripts-quality/GAPS.md), [docs/DEVELOPMENT_GUIDE.md](F:/Repos/Aralia/docs/DEVELOPMENT_GUIDE.md) | Keep unresolved monitoring gaps visible and bounded | run `npm run quality:debt` once and compare output shape to this map |
...
| Project docs now include file map, integrations, scope boundaries, and gap log | updated | Worker C | 2026-05-31 |
