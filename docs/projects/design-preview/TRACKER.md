...
| T2 | active | Capture design workflow and owners in a durable place | Worker B | 2026-05-31 | `docs/projects/PROJECT_TRACKER.md`, `docs/projects/design-preview/GAPS.md` | Add owner/responsibility notes and review cadence for lane/variant changes | G1 transition with owner and expected cadence |
...
|---|---|---|---|---|---|---|---|---|---|---|
| G1 | active | adjacent_follow_up | Worker B | `docs/projects/design-preview/GAPS.md` | scope review | Capture design workflow and owners | `docs/projects/PROJECT_TRACKER.md` | Prevents repeated ownership drift between preview lanes and owners | Resolve owner assignment and cadence in GAPS | Updated docs and next action state |
| G2 | not_started | support_needed_now | Worker B | `docs/projects/design-preview/GAPS.md` | scope review | No explicit visual-check runbook for Design Preview surfaces | `docs/projects/design-preview/NORTH_STAR.md` | Manual checks are required but not yet standardized | Add `Next Checks` checklist and optional Playwright target | Checklist present in NORTH_STAR |
