...
> monolithic effect reappears. The "Next Steps" phases below are historical; the `SpellEffect` union now
> lives in `src/types/spellEffectTypes.ts`. (A stray corrupted prefix on the original first line was
> repaired at archive time.)
...
<!-- aralia-backlog-walked: {"source":"docs/tasks/backlog-retirement/RETIREMENT_LEDGER.md","path":"docs/archive/spell-system/GAP-UNSPLIT-SPELL-EFFECTS.md","sha256WithoutMarker":"14cde87c7dc85948228e4d149b664358538cf4b6cf2cc2c44323a6a34f79a71f","markedAtUtc":"2026-08-09T20:22:07.623Z"} -->
