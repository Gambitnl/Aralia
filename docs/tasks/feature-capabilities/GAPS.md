...
|---|---|---|---|---|---|---|---|---|---|
| G1 | active | blocked_human_decision | Worker B | `docs/projects/character-creator/TRACKER.md` | capability scan | Clarify whether Character Creator should enforce strict step locking or keep permissive sidebar navigation | `docs/tasks/feature-capabilities/character-creator.md`, `src/components/CharacterCreator/CreationSidebar.tsx`, `src/components/CharacterCreator/config/sidebarSteps.ts` | The live code has completion checks but currently broad navigation, so acceptance can shift by interpretation | Decide and document product contract in `docs/projects/character-creator/NORTH_STAR.md` and keep this folder aligned | Decision recorded in the owning project tracker |
