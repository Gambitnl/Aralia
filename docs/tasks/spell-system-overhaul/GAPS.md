...
`TODO.md` has been retired. This legacy gap file preserves detailed SSO evidence,
including historical TODO references, while current routing lives under
`docs/projects/spells/SUBPROJECTS.md` and the relevant Spells child `GAPS.md`.
