...
| G19 | done | Setup-repair draft execution | The generated setup-repair draft expected `package-lock.json`, `package.json`, and `.github/workflows/ci.yml`, but the actual PR #935 review failure was in `.github/workflows/gemini-review.yml` | This was a Symphony setup-repair scoping gap; the fix updates future repair draft scope and records why the live repair intentionally touched `gemini-review.yml` | Decision 38; PR #937 merged; PR #935 branch updated with current `master` |
