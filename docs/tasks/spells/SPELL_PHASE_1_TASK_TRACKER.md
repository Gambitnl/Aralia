...
|---|---|---|---|---|---|
| P0 | active | Codex foreman | Symphony finalization baseline: post-ARA-6 contract, stale-status cleanup, branch/worktree discipline, decision reporting, task evidence pathways, artifact lifecycle rules | `EARLY_GAME_SPELL_EXECUTION_PLAN.md`, `SPELL_PHASE_1_ARTIFACT_LIFECYCLE_POLICY.md` | Setup PR #933, Package 2 workflow/closeout PRs, Package 3 handoff packet PR #939, Package 3 no-PR routing repair PR #947, publish-request docs PR #948, worktree local-sync gate repair PR #949, task-routing focus repair PR #951, wait-loop repair PR #955, post-feedback state-model repair PR #957, monitor-resync docs PR #958, Scout/Core feedback docs PR #959, Scout/Core evidence-refresh repair PR #960, posted-Scout-feedback wait-state repair PR #961, main-dashboard wait-state alignment PR #963, queue-action wait-state repair PR #965, queue-action merge docs PR #966, promoted-draft navigator cleanup PR #967, navigator cleanup merge docs PR #968, visible-Jules repair request docs PR #969, visible-Jules merge docs PR #970, feedback-delivery guidance PR #971, Package 3 closeout-docs PR #972, local-sync dashboard repair PR #973, and Package 3 receipt reconciliation PR #974 have landed; current monitor branch `codex/spell-phase1-monitor-31` matches `origin/master`, and dashboard-first closeout now points to Package 4 drafting while preserving the local-master sync blocker |
...
| P4 | active | Jules preferred after P3 closeout | Combat simulator deterministic spell pilot | `PACKAGE_4_COMBAT_SIMULATOR_DETERMINISTIC_PILOT_JULES_TASK.md`, `PACKAGE_4_COMBAT_SIMULATOR_DETERMINISTIC_PILOT_JULES_PROMPT.md`, `PACKAGE_4_SYMPHONY_TASK_DRAFT_PAYLOAD.json`, `PACKAGE_4_DISPATCH_READINESS_CHECKLIST.md`, `PACKAGE_4_COMBAT_PROOF_RECEIPT.md`, `PACKAGE_4_ATLAS_GATE_CHECKPOINT_RECEIPT.md` | Package 4 packet drafted for a bounded deterministic combat pilot: `fire-bolt` or equivalent cantrip damage, `magic-missile` or equivalent level-1 damage, `cure-wounds` or equivalent healing, and `bless` or equivalent simple buff/status. Next action: create the dashboard draft visibly through Symphony and route it to Jules. |
...
| `PACKAGE_4_COMBAT_SIMULATOR_DETERMINISTIC_PILOT_JULES_TASK.md` | Package 4 scope and acceptance criteria | draft-ready for dashboard intake |
| `PACKAGE_4_COMBAT_SIMULATOR_DETERMINISTIC_PILOT_JULES_PROMPT.md` | Exact Jules prompt for Package 4 | draft-ready for dashboard intake |
| `PACKAGE_4_SYMPHONY_TASK_DRAFT_PAYLOAD.json` | Dashboard draft payload for Package 4 | draft-ready for dashboard intake |
| `PACKAGE_4_DISPATCH_READINESS_CHECKLIST.md` | Handoff guard for Package 4 | draft-ready for dashboard intake |
