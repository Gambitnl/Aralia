...
| P4 | active | Jules preferred after P3 closeout | Combat simulator deterministic spell pilot | create `PACKAGE_4_*` docs after P3 | Next action: draft Package 4 task documents and use Symphony/Jules dashboard-first dispatch |
