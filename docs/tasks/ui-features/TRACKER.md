...
| G3 | active | adjacent_follow_up | Worker D | `docs/projects/crafting-ui/TRACKER.md` | `docs/tasks/ui-features` scan | Current crafting UI documents use mixed owner/placeholder labels across trackers | `docs/projects/crafting-ui/TRACKER.md`; `docs/projects/crafting-ui/GAPS.md` | Ambiguous owners increase restart risk across adjacent UI initiatives | Add a concise ownership handoff note in owning trackers when scope expands | No owner drift remains unrecorded before implementation |
