...
|---|---|---|
| crafting-ui | `docs/superpowers/specs/2026-07-14-absorbed-crafting-ui.md` | Implemented UI with cross-system contract follow-ups |
| economy-ui | `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md` | Mounted flow exists; modal entry/ownership gaps remain |
| glossary-ui | `docs/superpowers/specs/2026-07-14-absorbed-glossary-ui.md` | Implemented glossary surfaces and build path evidence |
...
| salvage-ui | `docs/superpowers/specs/2026-07-14-absorbed-crafting-ui.md` G8 | UI request is live, routed to Crafting UI, and pending integration |
...
- The retired `docs/tasks/CRAFTING_UI_TODO.md` assigned `Forge` or `Merchant`; current crafting follow-ups live in `docs/superpowers/specs/2026-07-14-absorbed-crafting-ui.md`.
...
|---|---|---|---|
| salvage-ui | `docs/superpowers/specs/2026-07-14-absorbed-crafting-ui.md` G8 | Alchemist / Crafting UI owner | Salvage action, confirmation, execution, and result feedback proof in Crafting UI. |
| economy-ui | `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md` G4/G6/G8 | Economy UI docs owner | Non-debug player entry point, Escape close parity, or transaction-routing proof in Economy UI. |
| glossary-ui | `docs/superpowers/specs/2026-07-14-absorbed-glossary-ui.md` G7/G8 | Worker / Codex by row | Schema-guard or spell-detail glossary-linking proof in Glossary UI. |
