...
|---|---|---|---|---|---|---|---|---|---|---|
| G1 | active | in_scope_now | Alchemist | `docs/superpowers/specs/2026-07-14-absorbed-crafting-ui.md` G8 | `docs/tasks/ui-features` scan | Salvage UI entry point is now routed to Crafting UI, but implementation is still pending. | `docs/superpowers/specs/2026-07-14-absorbed-crafting-ui.md` G8; `src/components/CharacterSheet/Overview/InventoryList.tsx`; `src/systems/crafting/salvageSystem.ts` | Missing implementation target blocks UI continuation of a backed system feature | Continue in Crafting UI G8; do not reopen the retired standalone task note. | Crafting UI G8 has component/rendered proof for salvage action, confirmation, execution, and result feedback. |
| G2 | active | support_needed_now | Economy UI docs owner | `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md` | `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md` scan + docs scan | Economy modal wiring is split across modal host, reducer flags, and callbacks with uncertain ownership | `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md`; `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md`; `src/components/layout/GameModals.tsx`; `src/components/Economy/*` | User-visible economy routes can stay partially unreachable or become inconsistent if ownership is not clarified | Update owning gap row in `docs/superpowers/specs/2026-07-14-absorbed-economy-ui.md` or equivalent before implementation | Concrete mount + action-routing proof for `LedgerBook`, `CourierPouch`, `InvestmentBoard` |
