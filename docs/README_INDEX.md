...
*   **[`docs/spells/STATUS_LEVEL_1.md`](./spells/STATUS_LEVEL_1.md)**: Detailed status tracking for Level 1 spells.
*   **[`docs/spells/STATUS_LEVEL_2.md`](./spells/STATUS_LEVEL_2.md)**: Detailed status tracking for Level 2 spells.
*   **[`docs/spells/STATUS_LEVEL_3.md`](./spells/STATUS_LEVEL_3.md)**: Detailed status tracking for Level 3 spells.
*   **[`docs/spells/STATUS_LEVEL_4.md`](./spells/STATUS_LEVEL_4.md)**: Detailed status tracking for Level 4 spells.
*   **[`docs/spells/STATUS_LEVEL_5.md`](./spells/STATUS_LEVEL_5.md)**: Detailed status tracking for Level 5 spells.
*   **[`docs/spells/STATUS_LEVEL_6.md`](./spells/STATUS_LEVEL_6.md)**: Detailed status tracking for Level 6 spells.
*   **[`docs/spells/STATUS_LEVEL_7.md`](./spells/STATUS_LEVEL_7.md)**: Detailed status tracking for Level 7 spells.
*   **[`docs/spells/STATUS_LEVEL_8.md`](./spells/STATUS_LEVEL_8.md)**: Detailed status tracking for Level 8 spells.
*   **[`docs/spells/STATUS_LEVEL_9.md`](./spells/STATUS_LEVEL_9.md)**: Detailed status tracking for Level 9 spells.
...
*   **[`docs/changelogs/glossary_equipment_changelog.md`](./changelogs/glossary_equipment_changelog.md)**: Details the addition of the Equipment section to the glossary.
...
### Config (`src/config/`)
*   **[`src/config/README.md`](../src/config/README.md)**: Overview of the configuration directory.
...
*   **[`src/hooks/actions/handleResourceActions.README.md`](../src/hooks/actions/handleResourceActions.README.md)**: Documents resource management action handlers.
...
*   **`src/components/CharacterCreator/state/characterCreatorState.README.md`**: Documents the state machine for character creation.
...
*   **`src/components/DynamicMannequinSlotIcon.README.md`**: Explains the `DynamicMannequinSlotIcon.tsx` component.
...
*   **[`src/utils/socialUtils.README.md`](../src/utils/socialUtils.README.md)**: Documents the social interaction utilities.


### Data Definitions (`src/data/`)

*   **`src/data/item_templates/README.md`**: Explains the generative item templates.
...
*   **`src/constants.README.md`**: Documents the `constants.ts` file.
*   **Race Data READMEs**: Individual READMEs for each race file in `src/data/races/` (e.g., `aarakocra.README.md`, `human.README.md`, etc.).

### Feature Documentation (`docs/features/`)
*   **[`docs/features/SUBMAP_GENERATION_EXPLAINED.md`](./features/SUBMAP_GENERATION_EXPLAINED.md)**: An in-depth technical explanation of the submap procedural generation system.
