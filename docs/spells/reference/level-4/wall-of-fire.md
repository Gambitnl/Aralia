...
- **Spatial Detail 1 Label**: Damage Side Radius
- **Spatial Detail 1 Kind**: distance
- **Spatial Detail 1 Value**: 10
- **Spatial Detail 1 Unit**: feet
- **Spatial Detail 1 Notes**: Only the chosen side deals this proximity damage.
