...
- **Somatic**: true
- **Material**: true
- **Material Description**: specially marked sticks, bones, or similar tokens worth 25+ GP
- **Material Cost GP**: 25
- **Consumed**: false
