...
- **Area Shape**: cube
- **Area Size**: 90
- **Target Instance Type**: animated_tree
...
- **Target Instance Notes**: The caster animates up to four existing trees inside the warded area as separate persistent grove guardians; their command, intruder trigger, ward boundary, and ending behavior remain tracked by the summon/control, message, ward, and conditional-ending buckets.
...
- **Somatic**: true
- **Material**: true
- **Material Description**: mistletoe, which the spell consumes, that was harvested with a golden sickle under the light of a full moon
- **Material Cost GP**: 0
- **Consumed**: true
...
Referenced Rules:
heavily obscured -> /rules/90-tooltip
