...
- **Higher Levels**: Using a Higher-Level Spell Slot. The damage for both effects of the spell increases by 1d8 for each spell slot level above 3.
- **Scaling Rule 1 Type**: slot_level_bonus
- **Scaling Rule 1 Applies To**: damage | primary 4d8 Lightning and secondary 2d8 Lightning
- **Scaling Rule 1 Bonus Per Level**: +1d8
- **Scaling Rule 1 Notes**: The slot-level bonus applies once to each linked damage effect: the direct hit/miss damage and the 10-foot secondary burst damage.
