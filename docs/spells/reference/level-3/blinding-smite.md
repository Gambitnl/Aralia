...
- **Reaction Trigger**: immediately after you hit a creature with a melee weapon or Unarmed Strike
...
- **Higher Levels**: Using a Higher-Level Spell Slot. The extra damage increases by 1d8 for each spell slot level above 3.
- **Scaling Rule 1 Type**: special_text
- **Scaling Rule 1 Applies To**: canonical higher-level prose
- **Scaling Rule 1 Notes**: The extra damage increases by 1d8 for each spell slot level above 3.
