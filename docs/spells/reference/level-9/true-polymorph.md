...
- **Range Type**: ranged
- **Range Distance**: 30
- **Targeting Type**: creature or object
- **Area Shape**: N/A
- **Area Size**: N/A
...
- **Somatic**: true
- **Material**: true
- **Material Description**: a drop of mercury, a dollop of gum arabic, and a wisp of smoke
- **Material Cost GP**: 0
- **Consumed**: false
...
Referenced Rules:
shape-shifts -> /rules-glossary/100-tooltip
