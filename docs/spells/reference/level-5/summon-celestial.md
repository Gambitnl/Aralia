...
- **Somatic**: true
- **Material**: true
- **Material Description**: a golden reliquary worth 500+ GP
...
- **Mode Choice Option 1 Label**: Avenger
- **Mode Choice Option 1 Summary**: Summon an Avenger Celestial Spirit that makes a long-range Radiant Bow attack.
...
- **Mode Choice Option 1 Notes**: Uses the Celestial Spirit stat block and slot-level scaling.
- **Mode Choice Option 2 Label**: Defender
- **Mode Choice Option 2 Summary**: Summon a Defender Celestial Spirit that makes a melee Radiant Mace attack and shields allies with temporary Hit Points.
...
- **Mode Choice Option 2 Notes**: Uses the Celestial Spirit stat block and slot-level scaling.
