...
- **Valid Targets**: creatures, objects, point
...
- **Somatic**: true
- **Material**: true
- **Material Description**: An eggshell and a snakeskin glove
- **Duration Type**: timed
- **Duration Value**: 1
...
- **Scaling Rule 1 Notes**: When you cast this spell using a spell slot of 6th level or higher, the damage from the clenched fist option increases by 2d8 and the damage from the grasping hand increases by 2d6 for each slot level above 5th.
