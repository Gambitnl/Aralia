...
- **Target Ability Threshold Ability**: Intelligence
- **Target Ability Threshold Operator**: greater_than
- **Target Ability Threshold Value**: 2
...
- **Somatic**: true
- **Material**: true
- **Material Description**: pieces of eggshell from two different kinds of creatures
- **Material Cost GP**: 0
- **Consumed**: false
