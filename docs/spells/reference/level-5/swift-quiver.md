...
- **Somatic**: true
- **Material**: true
- **Material Description**: a quiver containing at least one piece of ammunition
- **Material Cost GP**: 0
- **Consumed**: false
...
- **End Cleanup Removes**: created_ammunition
- **End Cleanup Source**: this_spell
- **End Cleanup Scope**: created_objects
- **End Cleanup Amount**: all_remaining
- **End Cleanup Consequence**: disintegrate
