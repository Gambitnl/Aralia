...
excerpt: "Speak a one-word command; on a failed Wisdom save the target obeys on its next turn."
seeAlso: ["suggestion", "hold-person"]
filePath: "/data/glossary/entries/spells/command.md"
---
<div class="spell-card">
  <div class="spell-card-header">
    <h1 class="spell-card-title">Command</h1>
  </div>
  ...
  <p class="spell-card-description">
    You speak a one-word command to a creature you can see within range. The target must succeed on a Wisdom saving throw or follow the command on its next turn. Options include Approach, Drop, Flee, Grovel, or Halt, forcing movement, dropping held items, or ending its turn as directed.
  </p>
  <p class="spell-card-description">
    <strong>At Higher Levels.</strong> You can target one additional creature for each slot level above 1st.
  </p>
