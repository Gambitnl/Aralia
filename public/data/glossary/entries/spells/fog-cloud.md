...
title: "Fog Cloud"
category: "Spells"
tags: ["level 1", "conjuration", "terrain", "concentration"]
excerpt: "Create a heavily obscuring 20-foot-radius fog sphere for up to 1 hour; radius scales with slot."
seeAlso: ["darkness", "wall-of-fog"]
filePath: "/data/glossary/entries/spells/fog-cloud.md"
---
<div class="spell-card">
  <div class="spell-card-header">
    <h1 class="spell-card-title">Fog Cloud</h1>
  </div>
  ...
  <div class="spell-card-stats-grid">
    ...
    <div class="spell-card-stat">
      ...
      <span class="spell-card-stat-value">120 ft. / 20-foot-radius sphere</span>
    </div>
    <div class="spell-card-stat">
    ...
    <div class="spell-card-stat">
      ...
      <span class="spell-card-stat-value">Concentration, up to 1 Hour</span>
    </div>
    <div class="spell-card-stat">
    ...
    <div class="spell-card-stat">
      ...
      <span class="spell-card-stat-value">Obscurement</span>
    </div>
  </div>
  <div class="spell-card-divider"></div>
  <p class="spell-card-description">
    You create a 20-foot-radius sphere of fog centered on a point within range. The sphere is heavily obscured and persists for the duration or until a strong wind disperses it.
  </p>
  <p class="spell-card-description">
    <strong>At Higher Levels.</strong> The fog's radius increases by 20 feet for each slot level above 1st.
  </p>
