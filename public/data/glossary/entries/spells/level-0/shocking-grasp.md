...
filePath: "/data/glossary/entries/spells/level-0/shocking-grasp.md"
---
<div class="spell-card">
  ...
  <p class="spell-card-description">
    <strong>Cantrip Upgrade.</strong> The damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8).
  </p>
  <div class="spell-card-tags-section">
    <span class="spell-card-tags-label">Spell Tags:</span>
    <span class="spell-card-tag">EVOCATION</span>
    <span class="spell-card-tag">DAMAGE</span>
    <span class="spell-card-tag">LIGHTNING</span>
