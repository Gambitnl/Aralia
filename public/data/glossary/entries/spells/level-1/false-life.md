...
title: "False Life"
category: "Spells"
tags: ["level 1", "necromancy", "temporary hp"]
excerpt: "Gain 2d4+4 temporary HP, +5 per slot level above 1st."
seeAlso: ["armor-of-agathys", "aid"]
filePath: "/data/glossary/entries/spells/level-1/false-life.md"
---
<div class="spell-card">
  <div class="spell-card-header">
    <h1 class="spell-card-title">False Life</h1>
  </div>
  ...
  <div class="spell-card-stats-grid">
    ...
    <div class="spell-card-stat">
      ...
      <span class="spell-card-stat-value">V, S, M (a drop of alcohol)</span>
    </div>
    <div class="spell-card-stat">
    ...
    <div class="spell-card-stat">
      ...
      <span class="spell-card-stat-value">Temporary HP</span>
    </div>
  </div>
  <div class="spell-card-divider"></div>
  <p class="spell-card-description">
    You bolster yourself with 2d4+4 temporary hit points.
  </p>
  <p class="spell-card-description">
    <strong>At Higher Levels.</strong> You gain 5 additional temporary hit points for each slot level above 1st.
  </p>
  <div class="spell-card-tags-section">
    <span class="spell-card-tags-label">Spell Tags:</span>
    <span class="spell-card-tag">TEMPORARY HP</span>
  </div>
  <div class="spell-card-tags-section">
