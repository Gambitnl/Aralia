...
excerpt: "Understand spoken, signed, or written language you perceive for 1 hour."
seeAlso: ["tongues", "detect-magic"]
filePath: "/data/glossary/entries/spells/level-1/comprehend-languages.md"
---
<div class="spell-card">
  <div class="spell-card-header">
    <h1 class="spell-card-title">Comprehend Languages</h1>
  </div>
  ...
  <div class="spell-card-stats-grid">
    ...
    <div class="spell-card-stat">
      ...
      <span class="spell-card-stat-value">V, S, M (a pinch of soot and salt)</span>
    </div>
    <div class="spell-card-stat">
  ...
  <p class="spell-card-description">
    For the duration, you understand the literal meaning of any language that you hear or see signed. You also understand any written language that you see while touching the surface, taking about 1 minute to read one page of text. The spell does not decode symbols or secret messages.
  </p>
  <div class="spell-card-tags-section">
    <span class="spell-card-tags-label">Spell Tags:</span>
    <span class="spell-card-tag">INFORMATION</span>
