 ...
 */
// TODO #249(FEATURES): Generate POIs procedurally and distribute them across the map instead of relying on static coordinates (see docs/FEATURES_TODO.md; if this block is moved/refactored/modularized, update the FEATURES_TODO entry path).
