 ...
 * Costs use rough rarity-based defaults; // TODO: revisit values and mechanical details during balance pass.
 */
...
export const CRAFTED_ITEMS: Record<string, Item> = {
  ...
  alchemists_fire: {
    ...
    // TODO: model ongoing burn/Extinguish action instead of single damage roll.
  ...
  blasting_powder: {
    ...
    weight: 0.5,
    rarity: ItemRarity.Common,
    // TODO: encode save DC and combined charge scaling once bomb mechanics are formalized.
  ...
  antitoxin: {
    ...
    weight: 0.25,
    rarity: ItemRarity.Common,
    // TODO: move to a status-effect representation when saves/conditions are formalized.
  ...
  potion_of_fire_breath: {
    ...
    weight: 0.5,
    rarity: ItemRarity.Uncommon,
    // TODO: support limited charges; for now capture the damage profile.
  ...
  oil_of_dragons_bane: {
    ...
    weight: 0.5,
    rarity: ItemRarity.Rare,
    // TODO: formalize creature-type bonus damage instead of narrative utility.
  ...
  potion_of_heroism: {
    ...
    weight: 0.5,
    rarity: ItemRarity.Rare,
    // TODO: split temp HP and Bless bonuses explicitly.
