...
import type { Range, SpellTargeting } from './spellTargeting';
import type { EffectSchedule, ModeChoice } from './spellEffectMetadata';
import type { AIContext, ArbitrationType } from './spellArbitrationMetadata';
import type { HigherLevelScaling } from './spellScalingMetadata';
...
export type { IllusionMetadata, IllusionRevealRule, SensoryChannel, SensoryManifestation, SensoryManifestationSize, SensoryManifestationVariant, } from './spellIllusionMetadata';
...
export type { AreaSizeBonusScaling, CharacterLevelTierScaling, HigherLevelScaling, HigherLevelScalingRule, MultipleHigherLevelScaling, ScalingFormula, SlotLevelBonusScaling, SlotLevelTableScaling, SpecialTextOnlyHigherLevelScaling, TargetCountBonusScaling, } from './spellScalingMetadata';
export type { BarrierDamagePrevention, DamageInteraction, DeathPrevention, LinkedDamage, ResistanceSuppression, SpellEffectPrevention, } from './spellProtectionMetadata';
export type { AttackAbilitySubstitution, AttackAugment, AttackDamageDieOverride, AttackDamageTypeChoice, AttackDamageTypeChoiceOption, AttackWeaponRequirement, GrantedAttack, } from './spellAttackMetadata';
export type { EffectSchedule, EffectScheduleEntry, EffectScheduleTargeting, ModeChoice, ModeChoiceOption, } from './spellEffectMetadata';
export type { AreaOfEffect, AreaTargetSelection, AreaTargeting, DistanceUnit, GeometrySizeType, HybridTargeting, MultiTargeting, PointTargeting, Range, ScalableNumber, ScalableNumberObject, SelfTargeting, SingleTargeting, SpatialDetails, SpatialForm, SpatialMeasuredDetail, SpatialMeasuredUnit, SpellTargeting, TargetAllocation, TargetCluster, TargetFilter, TargetInstanceAllocation, } from './spellTargeting';
export { isScalableNumberObject, resolveScalableNumber, } from './spellTargeting';
/**
