...
export type HigherLevelScalingRule = CharacterLevelTierScaling | SlotLevelBonusScaling | SlotLevelTableScaling | TargetCountBonusScaling | AreaSizeBonusScaling;
/** Top-level higher-level scaling container stored on a spell. */
export type HigherLevelScaling = HigherLevelScalingRule | MultipleHigherLevelScaling | SpecialTextOnlyHigherLevelScaling;
