...
export interface AreaOfEffect {
    shape: "Cone" | "Cube" | "Cylinder" | "Line" | "Sphere" | "Square" | "Circle" | "Emanation" | "Wall" | "Hemisphere" | "Ring";
    size: number;
...
export type GeometrySizeType = "radius" | "diameter" | "length" | "edge" | "side" | "square";
...
export interface SpatialMeasuredDetail {
    label: string;
    kind: "blocker" | "opening" | "diameter" | "thickness" | "depth" | "size_change" | "distance" | "count" | "volume" | "time" | "special";
    subject?: string;
    value?: number;
...
export type SpellTargeting = SingleTargeting | MultiTargeting | AreaTargeting | PointTargeting | SelfTargeting | HybridTargeting;
export {};
