 ...
 */
export type QuestType = 'Main' | 'Side' | 'Guild' | 'Dynamic' | 'Companion' | 'Rumor';
/**
 ...
 */
export type QuestObjectiveType = 'Kill' | 'Fetch' | 'Deliver' | 'Visit' | 'Interact' | 'Talk' | 'Escort' | 'Survive' | 'Custom';
/**
