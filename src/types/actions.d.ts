...
export type Action = {
    ...
    type: 'VISIT_GENERAL_STORE';
    payload?: never;
    label?: string;
} | {
    type: 'VISIT_BLACKSMITH';
    payload?: never;
    label?: string;
};
