...
import type { AtlasGroundDiscoveryProvenance, AtlasGroundPosition } from '../systems/worldforge/leaf3d/atlasGroundContinuity.js';
 ...
 */
export type AdventureLogKind = 'opening' | 'quest' | 'combat' | 'travel' | 'met-npc' | 'discovery' | 'rest';
/**
