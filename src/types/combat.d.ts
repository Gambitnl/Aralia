...
import type { DamageType, ConditionName, EffectDuration, SpellEffect, RepeatSave, SpellcastingRestriction, EscapeCheck, ConditionBreakTrigger, TargetFilter, AbilityCheckModifier, CreatedObject, IllusionMetadata, SensoryManifestation, TerrainManipulation, ConditionalEnding, BindingControl, DominationControl, ControlOption, TauntEffect, TauntBreakEvent, UtilityEffect } from "./spells.js";
...
export type OpeningThreatSocialRole = "contact-lead" | "screen-left" | "screen-right" | "escape-guard" | "pack-scout" | "scent-flanker";
/** Map-scale posture frozen into an opening scene instead of inferred by UI. */
export type OpeningThreatBodyPosture = "upright" | "crouched-left" | "crouched-right" | "rear-lean" | "low-scout" | "scenting";
/** Physical load that changes a creature's silhouette at tactical scale. */
export type OpeningThreatCarriedProfile = "none" | "salvage-pack" | "long-tool" | "buckler" | "rolled-bedding";
/**
...
export type WorldforgeCombatantSource = WorldforgeDefenderSource | WorldforgeOpeningThreatSource;
...
export type SelectedSpellTarget = {
    ...
    kind: "point";
    position: Position;
    purpose?: "ground_target" | "area_origin" | "teleport_destination" | string;
};
...
export type ThaumaturgyMode = "altered_eyes" | "booming_voice" | "fire_play" | "invisible_hand" | "phantom_sound" | "tremors";
...
export type BattleMapOccupantActivity = "sleeping" | "home" | "working" | "out" | "unknown";
/**
...
export type BattleMapSettlementHostilityRelation = {
    ...
    tier: "NEMESIS" | "HOSTILE" | "UNFRIENDLY" | "NEUTRAL" | "FRIENDLY" | "HONORED" | "REVERED";
...
export interface BattleMapOpeningActivitySite {
    ...
    contents: Array<"salvaged-container" | "torn-bedding" | "gnawed-remains" | "flattened-ground">;
}
/** What became of one exact WorldForge creature when the battle ended. */
export type BattleMapOpeningEntityOutcomeStatus = "downed" | "withdrew" | "holding-ground";
/**
 ...
 */
export declare const BATTLE_MAP_BIOMES: readonly ["forest", "cave", "dungeon", "desert", "swamp", "snow", "jungle", "coast", "ruins", "volcanic"];
...
export type CombatLogType = "action" | "damage" | "heal" | "status" | "summon" | "movement" | "turn_start" | "turn_end";
/**
...
export interface ActionCombatLogData extends CommonCombatLogData {
    ...
    utilityEffect?: Extract<SpellEffect, {
        type: "UTILITY";
    }>;
...
type ValueOfUnionField<Union, Field extends PropertyKey> = Union extends Union ? Field extends keyof Union ? Union[Field] : never : never;
