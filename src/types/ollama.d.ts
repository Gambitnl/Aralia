 ...
 */
export type TaskType = 'companion_banter' | 'companion_banter_escalation' | 'conversation_continuation' | 'npc_dialogue' | 'gossip' | 'emotional_reaction' | 'location_description' | 'wilderness_description' | 'encounter_description' | 'action_outcome' | 'dynamic_event' | 'opening_situation' | 'oracle_response' | 'social_check_outcome' | 'situation_analysis' | 'custom_action_suggestions' | 'guide_response' | 'conversation_summary' | 'fact_extraction' | 'name_generation' | 'tile_inspection' | 'harvest_loot';
/**
