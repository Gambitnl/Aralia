...
import type { Spell, DamageType, SavingThrowAbility as _SavingThrowAbility, ConditionName, EffectDuration, SpellEffect, RepeatSave, EscapeCheck, ConditionBreakTrigger } from './spells.js'; // Import Spell
