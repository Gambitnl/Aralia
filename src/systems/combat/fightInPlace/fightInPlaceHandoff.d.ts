...
export declare function setFightInPlaceHandoff(handoff: FightInPlaceHandoff): void;
/** Read the pending in-place fight context, if any. */
export declare function getFightInPlaceHandoff(): FightInPlaceHandoff | null;
/** Clear the handoff (call when the fight ends or is routed to the arena). */
export declare function clearFightInPlaceHandoff(): void;
