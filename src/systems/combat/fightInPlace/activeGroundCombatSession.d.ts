...
export type ActiveGroundCombatProvider = (request: ActiveGroundSettlementEncounterRequest) => Promise<ActiveGroundSettlementEncounterResult>;
...
export type ActiveGroundOpeningCombatProvider = (request: ActiveGroundOpeningEncounterRequest) => Promise<ActiveGroundOpeningEncounterResult>;
/**
 ...
 */
export declare function registerActiveGroundCombatProvider(provider: ActiveGroundCombatProvider): () => void;
/** Ask the live GroundWorld for a source encounter, if one is mounted. */
export declare function prepareActiveGroundSettlementEncounter(request: ActiveGroundSettlementEncounterRequest): Promise<ActiveGroundSettlementEncounterResult>;
/** Publish the opening projector owned by the currently mounted GroundWorld. */
export declare function registerActiveGroundOpeningCombatProvider(provider: ActiveGroundOpeningCombatProvider): () => void;
/** Ask the live GroundWorld to validate and project one hostile opening. */
export declare function prepareActiveGroundOpeningEncounter(request: ActiveGroundOpeningEncounterRequest): Promise<ActiveGroundOpeningEncounterResult>;
