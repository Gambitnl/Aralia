 ...
 */
import type { BattleMapOpeningActivitySite, BattleMapOpeningEcologicalTrace, BattleMapOpeningSceneResolution, BattleMapOpeningTerrainImprint, WorldforgeOpeningThreatSource } from "@/types/combat";
...
interface OpeningThreatSceneReceiptBase {
    ...
    entities: Array<WorldforgeOpeningThreatSource & {
        sourcePatchTile: {
            x: number;
            y: number;
        };
...
export type OpeningThreatSceneReceipt = OpeningThreatSceneReceiptV1 | OpeningThreatSceneReceiptV2;
/** Every generated-world encounter record accepted by GameState. */
export type WorldforgeEncounterReceipt = StatePatrolEncounterReceipt | OpeningThreatSceneReceipt;
export {};
