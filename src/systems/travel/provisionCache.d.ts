...
export declare function addCache(caches: readonly ProvisionCache[], cache: ProvisionCache): ProvisionCache[];
/** Remove a cache by id (immutably). */
export declare function removeCache(caches: readonly ProvisionCache[], id: string): ProvisionCache[];
/** The cache stored at a given atlas cell, or undefined. */
export declare function cacheAtCell(caches: readonly ProvisionCache[], atlasCell: number): ProvisionCache | undefined;
/**
 ...
 */
export declare function reachableCaches(caches: readonly ProvisionCache[], reachableCellIds: ReadonlySet<number>): ProvisionCache[];
/** Travel-days a cache's stored resource grants `consumers` people (floored). */
export declare function cacheReachDays(cache: ProvisionCache, resource: ProvisionResource, consumers: number): number;
