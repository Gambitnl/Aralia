 ...
 */
export declare const SOFT_PARTY_CAP = 6;
/** Anything with a length is countable; keep coupling minimal. */
type CountableParty = ReadonlyArray<PlayerCharacter> | {
    length: number;
} | null | undefined;
/**
 ...
 */
export declare function partyCount(party: CountableParty): number;
/**
 * Whether the party is over the advisory soft cap.
 * UI-hint only — does NOT mean recruiting should be blocked.
 */
export declare function isOverSoftCap(party: CountableParty): boolean;
export {};
