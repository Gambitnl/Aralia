...
import catapult from '@/data/spells/level-1/catapult.json'
import cureWounds from '@/data/spells/level-1/cure-wounds.json'
...
import gentleRepose from '@/data/spells/level-2/gentle-repose.json'
import guidance from '@/data/spells/level-0/guidance.json'
import mistyStep from '@/data/spells/level-2/misty-step.json'
