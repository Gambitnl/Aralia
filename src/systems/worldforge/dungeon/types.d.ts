 ...
 */
export type ChronicleKind = 'war' | 'plague' | 'eruption' | 'schism' | 'crusade' | 'migration' | 'fall';
/**
...
export declare const CELL_FT = 5;
...
export type RoomPurpose = 'stair' | 'antechamber' | 'chapel' | 'burial-gallery' | 'ossuary' | 'treasury' | 'embalming' | 'adit' | 'hoist' | 'tool-store' | 'barracks' | 'vein-gallery' | 'sump' | 'gatehouse' | 'great-hall' | 'armory' | 'granary' | 'kitchen' | 'cellar' | 'chapel-wing' | 'junction' | 'cistern' | 'maintenance-walk' | 'ladder-shaft' | 'outfall' | 'passage-room';
export type BuilderArchetype = 'mausoleum' | 'mine' | 'fortress' | 'waterworks';
export type EventKind = 'seal' | 'collapse' | 'flood' | 'tunnel' | 'brick-off' | 'den' | 'plunder' | 'fire' | 'reoccupy' | 'awaken' | 'bloom';
