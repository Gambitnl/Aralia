...
import type { BuilderArchetype, DoorState, DungeonEdge, DungeonEvent, DungeonTheme } from '../types';
...
export declare const ACTORS: Record<DungeonTheme, ActorVocab>;
