...
export declare function scheduleHourFromGameTime(gameTime: Date): number;
/**
 ...
 */
export declare function scheduleClockFromGameTime(gameTime: Date): number;
/**
 ...
 */
export declare function windowProgress(clock: number, startHour: number, endHour: number): number;
