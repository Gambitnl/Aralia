import { type StreetGraph } from '../roster/agentPath';
 ...
 */
export declare function groundTownAgentsAt(burgId: number, plan: TownPlan, roster: TownRoster, boundsFeet: BoundsFeet, clock: number, graph?: StreetGraph): GroundAgentMotion[];
/**
 ...
 */
export declare function allGroundAgentsAt(ground: GroundWorld, clock: number): GroundAgentMotion[];
...
export type AgentBodyDims = Map<number, {
    heightM: number;
    widthM: number;
}>;
/**
 ...
 */
export declare function groundAgentScenePositions(ground: GroundWorld, clock: number, 
...
bodies?: AgentBodyDims): GroundAgentSceneNode[];
