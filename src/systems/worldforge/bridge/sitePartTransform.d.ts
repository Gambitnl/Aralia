 ...
 */
export declare function isSitePartRenderable(part: Pick<SitePart, 'renderRole'>): boolean;
 ...
 */
export declare function sitePartLocalOffset(part: PartOffsetInput, doorZSign: number): {
    x: number;
    y: number;
    z: number;
};
 ...
 */
export declare function sitePartScenePosition(part: PartOffsetInput, t: SiteGroupTransform): {
    x: number;
    y: number;
    z: number;
};
 ...
 */
export declare function siteOrientationFromQuad(corners: ReadonlyArray<QuadCorner>): {
    rotationY: number;
    doorZSign: number;
};
/**
 ...
 */
export declare function worldOffsetToSiteLocal(dx: number, dz: number, rotationY: number): {
    lx: number;
    lz: number;
};
export {};
