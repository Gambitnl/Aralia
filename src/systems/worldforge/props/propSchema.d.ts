...
export declare const CELL_METERS = 1.524;
/**
...
export declare function providesCover(def: PropDefinition): boolean;
/**
 ...
 */
export declare function validatePropDefinition(def: PropDefinition): string[];
