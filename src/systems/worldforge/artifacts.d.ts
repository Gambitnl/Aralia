 ...
 */
export declare const WORLDFORGE_SCHEMA_VERSION = 1;
...
export type TerrainMaterial = 'grass' | 'dirt' | 'rock' | 'sand' | 'wetland' | 'water' | 'paved' | 'floor' | 'ice';
...
export type AnyWorldforgeArtifact = AtlasArtifact | RegionArtifact | LocalArtifact | GroundArtifact;
