 ...
 */
export declare const DEFAULT_WORLD_GEN_OPTIONS: WorldGenOptions;
/**
 ...
 */
export declare function freezeWorldGenOptions(opts: WorldGenOptions): Readonly<WorldGenOptions>;
