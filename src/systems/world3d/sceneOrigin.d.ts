...
export declare function worldToScene(worldX: number, worldZ: number, origin: SceneOrigin): {
    x: number;
    z: number;
};
export declare function sceneToWorld(sceneX: number, sceneZ: number, origin: SceneOrigin): {
    x: number;
    z: number;
};
