...
export declare const WORLD3D_CONFIG: {
     ...
     */
    readonly STREAMED_WORLD_SHADOWS: true;
};
/** Derived: number of chunks spanning one grid cell along each axis. */
export declare const CHUNKS_PER_CELL: number;
/**
 ...
 */
export declare function heightToMeters(height: number): number;
/**
 ...
 */
export declare function resolutionForLod(lod?: LodTier): number;
