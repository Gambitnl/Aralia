...
import alarm from '@/data/spells/level-1/alarm.json'
import chromaticOrb from '@/data/spells/level-1/chromatic-orb.json'
import alterSelf from '@/data/spells/level-2/alter-self.json'
import blindnessDeafness from '@/data/spells/level-2/blindness-deafness.json'
import dragonsBreath from '@/data/spells/level-2/dragons-breath.json'
import enhanceAbility from '@/data/spells/level-2/enhance-ability.json'
import enlargeReduce from '@/data/spells/level-2/enlarge-reduce.json'
import plantGrowth from '@/data/spells/level-3/plant-growth.json'
