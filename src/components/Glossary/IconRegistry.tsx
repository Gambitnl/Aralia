...
export const GlossaryIcon: React.FC<GlossaryIconProps> = ({ name, className = "w-4 h-4" }) => {
    const icons: Record<string, React.ReactNode> = {
        ...
        creation: (
            <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
                <path d="M19,1L17.74,3.75L15,5L17.74,6.26L19,9L20.25,6.26L23,5L20.25,3.75L19,1M9,4L6.5,9.5L1,12L6.5,14.5L9,20L11.5,14.5L17,12L11.5,9.5L9,4M19,15L17.74,17.75L15,19L17.74,20.26L19,23L20.25,20.26L23,19L20.25,17.75L19,15Z" />
            </svg>
        ),
        settings_heart: (
            <svg viewBox="0 -960 960 960" fill="currentColor" className={className}>
