...
export const GlossaryIcon: React.FC<GlossaryIconProps> = ({ name, className = "w-4 h-4" }) => {
    const icons: Record<string, React.ReactNode> = {
        ...
        flower: (
            <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
                <path d="M5.6 10C5.93 10.68 6 11.43 5.84 11.93C5.71 12.26 5.53 12.34 5.47 12.36C4.92 12.6 3.88 12 3.3 10.87C2.9 10.06 2.91 9.35 3.05 8.94C3.13 8.73 3.25 8.58 3.4 8.5C3.5 8.5 3.57 8.46 3.68 8.46C4.26 8.46 5.1 9.03 5.6 10Z M15.16 10H13.5L17.34 16H6.67L10.53 10H8.84L12 5.5L15.16 10Z" />
            </svg>
        ),
        mountain: (
            <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
