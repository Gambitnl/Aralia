  ...
  return (
    <div className="bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-700">
      ...
      <div className="mt-6 pt-4 border-t border-gray-700 grid grid-cols-2 gap-2">
         ...
         <ActionButton action={{ type: 'save_game', label: 'Save Game' }} onClick={onAction} disabled={disabled} />
         {isDevDummyActive && (
            <ActionButton action={{ type: 'toggle_dev_menu', label: 'Dev Menu' }} onClick={onAction} disabled={disabled} hasNotification={hasNewRateLimitError} />
         )}
      </div>
    </div>
  );
