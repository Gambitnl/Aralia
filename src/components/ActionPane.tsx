...
const ActionButton: React.FC<{
  ...
  const baseClasses = "font-semibold py-3 px-6 rounded-lg shadow-md transition-all duration-150 ease-in-out transform focus:outline-none focus:ring-2 focus:ring-opacity-75 relative";
  
  let colorClasses = "bg-sky-600 hover:bg-sky-500 disabled:bg-gray-600 text-white focus:ring-sky-400";
  
  // Determine color based on action type
  if (action.type === 'toggle_party_overlay') colorClasses = "bg-green-600 hover:bg-green-500 text-white focus:ring-green-400";
  else if (action.type === 'save_game') colorClasses = "bg-yellow-500 hover:bg-yellow-400 disabled:bg-gray-600 text-gray-900 focus:ring-yellow-300";
  else if (action.type === 'go_to_main_menu') colorClasses = "bg-red-600 hover:bg-red-500 disabled:bg-gray-600 text-white focus:ring-red-400";
  else if (action.type === 'toggle_dev_menu') colorClasses = "bg-orange-500 hover:bg-orange-400 disabled:bg-gray-600 text-white focus:ring-orange-300";
  else if (action.type === 'gemini_custom_action') colorClasses = "bg-teal-600 hover:bg-teal-500 disabled:bg-gray-600 text-white focus:ring-teal-400";
  else if (action.type === 'ask_oracle' || (action.type === 'custom' && action.label.toLowerCase().includes('oracle'))) colorClasses = "bg-purple-600 hover:bg-purple-500 disabled:bg-gray-600 text-white focus:ring-purple-400";
  else if (action.type === 'ANALYZE_SITUATION') colorClasses = "bg-indigo-500 hover:bg-indigo-400 disabled:bg-gray-600 text-white focus:ring-indigo-300";
  else if (action.type === 'TOGGLE_DISCOVERY_LOG') colorClasses = "bg-lime-600 hover:bg-lime-500 disabled:bg-gray-600 text-white focus:ring-lime-400";
  else if (action.type === 'TOGGLE_LOGBOOK') colorClasses = "bg-amber-600 hover:bg-amber-500 disabled:bg-gray-600 text-white focus:ring-amber-400";
  else if (action.type === 'TOGGLE_QUEST_LOG') colorClasses = "bg-amber-700 hover:bg-amber-600 disabled:bg-gray-600 text-white focus:ring-amber-500";
  else if (action.type === 'TOGGLE_GLOSSARY_VISIBILITY') colorClasses = "bg-indigo-600 hover:bg-indigo-500 disabled:bg-gray-600 text-white focus:ring-indigo-400";
  else if (action.type === 'TOGGLE_GAME_GUIDE') colorClasses = "bg-blue-700 hover:bg-blue-600 disabled:bg-gray-600 text-white focus:ring-blue-500";
