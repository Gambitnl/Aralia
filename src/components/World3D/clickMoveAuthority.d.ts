 ...
 */
export declare const CLICK_MOVE_ARRIVE_EPSILON_M = 0.75;
/**
 ...
 */
export declare function hasArrivedAtIntent(target: GroundPointM | null, current: GroundPointM | null, epsilonM?: number): boolean;
/**
 ...
 * any tile.
 */
export declare function isIntentOnTile(intent: ClickMoveIntent, tileX: number, tileY: number): boolean;
/**
 ...
 */
export declare function cameraMayWriteGroundPos(intent: GroundPointM | null, current: GroundPointM | null, epsilonM?: number): boolean;
