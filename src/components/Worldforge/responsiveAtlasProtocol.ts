...
// ============================================================================
// A request carries only deterministic inputs. The response returns the exact
// existing atlas boundary plus its pure render model, or a readable failure.
// ============================================================================
...
export type ResponsiveAtlasResponse =
  | Pick<ResponsiveAtlasPrepared, 'atlas' | 'transferProperties'> & { type: 'atlas' }
  | Pick<ResponsiveAtlasPrepared, 'model'> & { type: 'model' }
