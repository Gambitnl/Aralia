...
export const useAbilitySystem = ({
  ...
  // Used by Getters (Reactive) and Actions (Stable)
  // We keep this reactive for correctness in isValidTarget
   ...
   * REACTIVE: Must update when map or characters change to ensure UI is correct.
   */
   ...
   * REACTIVE: Updates when isValidTarget updates (which updates when map/chars update).
   */
