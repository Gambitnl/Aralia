...
describe('physicsUtils - Movement Cost', () => {
  ...
  it('stacks everything (Difficult + Climbing + Swimming + Crawling)', () => {
    ...
    expect(calculateMovementCost(10, {
      isDifficultTerrain: true,
      isClimbing: true,
      isSwimming: true,
      isCrawling: true
