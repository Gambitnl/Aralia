...
export const biomeVisualsConfig: Record<string, BiomeVisuals> = {
  'forest': {
    ...
    seededFeatures: [
      ...
      { id: 'village', name: 'Forest Village', icon: '🏘️', color: 'rgba(146, 153, 165, 0.75)', sizeRange: [0, 0], numSeedsRange: [0, 2], adjacency: { color: 'rgba(166, 173, 185, 0.6)' }, zOffset: 0.5, generatesEffectiveTerrainType: 'village_area', scatterOverride: [{ icon: '▫️', density: 0.4, color: 'rgba(176, 183, 195, 0.8)', allowedOn: ['village_area'] }, { icon: '🧍', density: 0.03, allowedOn: ['village_area'] }], shapeType: 'rectangular' },
    ],
  ...
  'mountain': {
    ...
    seededFeatures: [
      ...
      { id: 'village', name: 'Mountain Village', icon: '🏘️', color: 'rgba(136, 143, 155, 0.75)', sizeRange: [0, 0], numSeedsRange: [0, 1], adjacency: { color: 'rgba(156, 163, 175, 0.6)' }, zOffset: 0.5, generatesEffectiveTerrainType: 'village_area', scatterOverride: [{ icon: '▫️', density: 0.3, color: 'rgba(166, 173, 185, 0.8)', allowedOn: ['village_area'] }, { icon: '🧍', density: 0.02, allowedOn: ['village_area'] }], shapeType: 'rectangular' },
    ],
  ...
  'hills': {
    ...
    seededFeatures: [
      ...
      { id: 'village', name: 'Hilltop Village', icon: '🏘️', color: 'rgba(156, 163, 175, 0.75)', sizeRange: [0, 0], numSeedsRange: [0, 2], adjacency: { color: 'rgba(176, 183, 195, 0.6)' }, zOffset: 0.5, generatesEffectiveTerrainType: 'village_area', scatterOverride: [{ icon: '▫️', density: 0.4, color: 'rgba(186, 193, 205, 0.8)', allowedOn: ['village_area'] }, { icon: '🧍', density: 0.03, allowedOn: ['village_area'] }], shapeType: 'rectangular' },
    ],
  ...
  'cave': {
    baseColors: ['rgba(40, 35, 30, 0.95)'], // Deep dark brown/black for fallback
    pathColor: 'rgba(0,0,0,0)', // No paths
    scatterFeatures: [
      { icon: '🪨', density: 0.08, allowedOn: ['floor'] },
      { icon: '💧', density: 0.03, allowedOn: ['floor'] },
      { icon: '✨', density: 0.01, allowedOn: ['floor'], color: 'rgba(200,200,255,0.3)' },
      { icon: '🦇', density: 0.02, allowedOn: ['floor', 'wall'] },
      { icon: '🍄', density: 0.04, allowedOn: ['floor'] }
    ],
    caTileVisuals: {
      'wall': { color: 'rgba(20, 15, 10, 0.98)', icon: null },
      'floor': { color: 'rgba(60, 55, 50, 0.9)', icon: null }
    }
  },
  'dungeon': {
    baseColors: ['rgba(20, 20, 25, 0.95)'], // Very dark grey
    pathColor: 'rgba(0,0,0,0)',
    scatterFeatures: [
      { icon: '💀', density: 0.03, allowedOn: ['floor'] },
      { icon: '🕯️', density: 0.02, allowedOn: ['floor'] },
      { icon: '⛓️', density: 0.04, allowedOn: ['wall'] },
      { icon: '🕸️', density: 0.05, allowedOn: ['wall', 'floor'] },
      { icon: '🏺', density: 0.02, allowedOn: ['floor'] }
    ],
    caTileVisuals: {
      'wall': { color: 'rgba(40, 40, 45, 0.98)', icon: '🧱' },
      'floor': { color: 'rgba(80, 80, 85, 0.9)', icon: null }
    }
  }
};
