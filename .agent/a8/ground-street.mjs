...
await page.mouse.down();
await page.mouse.move(cx + 300, cy + 260, { steps: 20 });
await page.mouse.up();
await new Promise(r => setTimeout(r, 3000));
for (let a = 0; a < 4; a++) { try { await page.screenshot({ path: 'ground-street.png', timeout: 15000 }); console.log('saved ground-street.png'); break; } catch { await new Promise(r => setTimeout(r, 1500)); } }
await browser.close();
