...
await page.goto('http://localhost:5176/Aralia/?wf_ground=1&wf_roofless=1&wf_seed=42&wf_town=1', { waitUntil: 'domcontentloaded' });
...
await ev((tt) => window.__wf3dSetPose && window.__wf3dSetPose([tt[0] + 14, tt[1] + 10, tt[2] + 14], [tt[0], tt[1], tt[2]]), t);
await new Promise(r => setTimeout(r, 3500));
for (let a = 0; a < 4; a++) { try { await page.screenshot({ path: 'villagers-people.png', timeout: 15000 }); console.log('saved villagers-people.png at', JSON.stringify(t)); break; } catch { await new Promise(r => setTimeout(r, 1500)); } }
await browser.close();
