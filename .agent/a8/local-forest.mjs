...
await new Promise(r => setTimeout(r, 1500));
await page.screenshot({ path: 'local-forest.png' });
console.log('saved local-forest.png');
...
await page.screenshot({ path: 'local-forest-zoom.png' });
console.log('saved local-forest-zoom.png');
await browser.close();
