...
await new Promise(r => setTimeout(r, 4000));
await page.screenshot({ path: 'redeem-1-worldmap.png', timeout: 15000 }).catch(() => {});
...
await page.screenshot({ path: 'redeem-2-result.png', timeout: 15000 }).catch(() => console.log('shot3 failed'));
await browser.close();
