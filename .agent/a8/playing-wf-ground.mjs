...
await page.goto('http://localhost:5174/Aralia/?wf_ground=1', { waitUntil: 'domcontentloaded' });
...
for (let a = 0; a < 5; a++) {
  try { await page.screenshot({ path: 'playing-wf-ground.png', timeout: 15000 }); console.log('saved'); break; }
