/**
 * A8 proof capture — in-game region view after the WF-G4 fix.
...
await page.mouse.click(canvas.x + 285.9, canvas.y + 63.43);
for (let i = 0; i < 25; i++) {
...
console.log('HUD:', hud);
await page.screenshot({ path: '../../docs/projects/worldforge/orchestration/proof/laneA8-region-ingame.png' });
