...
1.  **Pre-Flight Check (Crucial)**
    - [ ] **Search for Duplicates**: Run `Select-String -Path src/components/Glossary/IconRegistry.tsx -Pattern "icon_name"` to ensure the key doesn't already exist.
...
2.  **Source & Implement**
    ...
    - [ ] **Verify Write**: Read the file back (`view_file`) to confirm the new SVG is present and correct.
