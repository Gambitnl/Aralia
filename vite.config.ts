...
const devHubApiManager = () => ({
  ...
  configureServer(server: any) {
    ...
    server.middlewares.use((req: any, res: any, next: any) => {
      ...
      // ============================================================================
      // Markdown Library System APIs
      // ============================================================================
      // Technical:
      // - GET /api/docs/list: recursive markdown scanner with YAML frontmatter parsing.
      // - GET /api/docs/read: direct file reader with traversal security checks.
      // - POST /api/docs/write: frontmatter injector and content writer.
      // - POST /api/docs/delete: soft-retire (tilde rename) or hard-deletion.
      // - Keeps co-located frontmatter synced with F:/Repos/Aralia/docs/registry/@DOC-REVIEW-LEDGER.md.
      // ============================================================================
