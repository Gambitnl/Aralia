...
- [~] Task: Refine data extraction script to prioritize internal file headers (`Created:`) and filter out vendor repos.
...
- [x] Task: Conductor - User Manual Verification 'Layout Engine' (Protocol in workflow.md) [b40d203]

## Phase 3: High-Granularity & Performance
- [x] Task: Implement "Drill-down" sub-view component for Milestone nodes.
- [ ] Task: Implement "Sub-Roadmap Modal" for viewing individual atomic items (spells, small fixes) within a milestone.
...
- [x] Task: Conductor - User Manual Verification 'Performance & Drill-down' (Protocol in workflow.md) [b40d203]
