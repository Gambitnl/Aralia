...
assert.match(openTasks, /verify-repair-push-result-receipt\.mjs/);
assert.match(openTasks, /local `repairPushResult`/);
...
assert.match(openTasks, /coordinator\/dependency repair path/);
...
assert.match(openTasks, /Stop PR-local mutation for this blocker and decide the coordinator\/dependency lockfile repair path/);
...
assert.match(openTasks, /verify-repair-lane-local-draft\.mjs/);
