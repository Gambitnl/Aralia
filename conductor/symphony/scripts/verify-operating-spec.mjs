...
assert.match(openTasks, /local-only approval checkpoint, operator-answer, and repair-push-result\s+receipt forms/);
...
assert.match(openTasks, /live task-chat usage and true external task actions remain open/);
