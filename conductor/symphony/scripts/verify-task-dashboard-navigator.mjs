...
assert.match(dashboardSource, /function createPackage10TargetFilterDraft/);
assert.match(dashboardSource, /PACKAGE_11_STATUS_STATE_DRAFT/);
assert.match(dashboardSource, /function createPackage11StatusStateDraft/);
assert.match(dashboardSource, /PACKAGE_12_CONDITIONAL_ENDING_DRAFT/);
assert.match(dashboardSource, /function createPackage12ConditionalEndingDraft/);
