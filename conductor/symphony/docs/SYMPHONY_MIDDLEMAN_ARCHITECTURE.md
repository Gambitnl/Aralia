...
- Use [`SYMPHONY_DASHBOARD_UX_BRIEF.md`](./SYMPHONY_DASHBOARD_UX_BRIEF.md) for the user-facing dashboard target, no-flicker refresh rules, and Stitch-aided design exploration policy.
